...
Constesta estas breves preguntas de repaso.
...
Escribe una descripción breve de cada uno de los símbolos y comandos de MATLAB/Octave que consideres útiles para recordar lo visto en la sesión. La lista debería incluir \matlab{readtable, find, strfind, count, array2table}.
