...
\newcommand{\thetime}{Lu 18:00--21:00}
...
\begin{document}
  ...
  \begin{itemize}
    ...
    Disponible en: \url{https://web.ti.bfh.ch/~sha1/Labs/PWF/Documentation/OctaveAtBFH.pdf}
  ...
  \begin{flushleft}
  Examen 1 \dotfill ~11 de febrero \\
  % Semana \textit{i} \dotfill ~TBD\\
  Examen 2 \dotfill ~25 de marzo \\
  Examen final \dotfill ~13 de mayo
  \end{flushleft}
  \end{minipage}
  \end{center}
  ...
  \begin{itemize}
  \item La entrada al salón de clases es a la hora especificada. Una vez iniciada la clase, se procederá a tomar asistencia. Después de 15 minutos, podrás ingresar al salón con falta.
  ...
  \item \textbf{Recuerda que debes cumplir con un porcentaje mínimo de asistencia}. Es necesario asistir al menos al 80\% de las sesiones previas a un examen para tener derecho a presentarlo. No faltes a clase si no es absolutamente necesario.
