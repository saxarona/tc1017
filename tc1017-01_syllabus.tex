...
\begin{document}
  ...
  \item Las soluciones a las tareas deberán ser entregadas en limpio y en formato digital (\textit{typeset}), en un archivo \texttt{.m} y subidas a la plataforma. Evita subir fotos o escaneos de trabajos a mano.
