...
24.01.19} %You should write the date here.
\end{center}
...
\begin{enumerate}[label=\alph*)]
    ...
    \begin{itemize}
        \item \textdf{Fecha}, en formato \texttt{DD.MM.AA}. Por ejemplo: \texttt{12.02.19} para el 12 de febrero de 2019.
    ...
    \begin{itemize}
        \item \textdf{Fecha}, en formato \texttt{DD.MM.AA}. Por ejemplo: \texttt{12.02.19} para el 12 de febrero de 2019.
        \item \textdf{Tipo de juego}. Si es \textit{pvp}, nombre del mapa o tipo de \textit{match}, por ejemplo: \texttt{Summoner's Rift} o \texttt{Hanamura}. \texttt{NA} si no aplica.
        \item \textdf{Duración}. Cuánto tardaste en el \textit{match} o mapa o nivel. \textbf{Se sugiere fuertemente que uses una sola unidad de tiempo}, por ejemplo \texttt{73} minutos.
