...
\begin{center}
{\huge Solución de Problemas con Programación TC1017 -- 01}\\[1.5ex]
{\large \textbf{Tarea 01}\\[1.5ex] %You should put your name here
22.01.19} %You should write the date here.
\end{center}
...
Entrega un documento \textdf{PDF} con tus respuestas y no olvides citar tus fuentes de manera adecuada (IEEE, ACM, APA). Asegúrate de que sean fuentes fiables y, de ser posible, lista dos o tres recursos; no te quedes con la primera definición que encuentres.
\end{document}
